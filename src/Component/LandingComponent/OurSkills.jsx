...
const OurSkills = () => {
  ...
  return (
    <div id="content-two-box" className="lg:w-10/12 md:w:10/12 w-full m-auto">
      <div
        id="content-three"
        className="lg:w-full md:w-full w-10/12 m-auto mt-40"
      >
        <div className="text-center text-4xl tracking-widest">
          Our{" "}
          <span className="tracking-widest bg-gradient-to-br from-blue-700 from-10% to-purple-700 to-100%0% w-56 text-transparent bg-clip-text">
            Skills
          </span>
        </div>
        <div
                  ...
                  {data.skills.development.map((skill, index) => (
                    <div className="w-full flex flex-col lg:mt-12 mt-5">
                      <div className="w-full flex justify-between lg:text-lg text-xs">
                        ...
                        <span id="skillValue" className="text-gray-500">
                          {skill.value}%
                        </span>
                      </div>
                      ...
                      <div className="mt-2 relative z-10">
                        <div
                          style={{ background: "#6C63FF80" }}
                          className="w-full rounded-full lg:h-2.5 h-1.5"
                        >
                          <div style={{ width: skill.value + "%" }}>
                            ...
                            <div
                              id="progress"
                              className={
                                "skills-animation relative bg-gradient-to-r from-blue-700 from-10% to-purple-700 to-50% lg:h-2.5 h-1.5 rounded-full box-border"
                              }
                              style={{ width: "0%", boxShadow: "100px" }}
                            ></div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="mt-2 relative z-10">
                      ...
                      >
                        <div style={{ width: skill.value + "%" }}>
                          <div
                            id="progress"
                            className="skills-animation relative bg-gradient-to-r from-blue-700 to-purple-700 lg:h-2.5 h-1.5 rounded-full box-border"
                            style={{ width: "0px", boxShadow: "100px" }}
                          ></div>
                        </div>
                      </div>
                    </div>
