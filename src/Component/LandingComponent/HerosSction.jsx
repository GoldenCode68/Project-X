  ...
  useEffect(() => {
    AOS.init();
      var typed = new Typed(text.current, { 
        strings: ["Welcome to our journey of innovation and growth. Here, we showcase our passion, skills, and achievements, reflecting the hard work and dedication we've put into our projects. Explore our work and see how we transform ideas into reality, one project at a time"], 
        typeSpeed: 20, 
        backSpeed: 25, 
        loop: false,
        showCursor: false,
  ...
  return (
    <div id="hero-box" className="lg:w-10/12 md:w:10/12 w-full m-auto">
        ...
        <div className="lg:text-5xl text-2xl tracking-wider lg:w-2/3 lg:mt-0 -mt-44" data-aos="fade-right" data-aos-duration="900">
          ...
          <div  id="text" style={{fontFamily: "inter"}} class="lg:w-5/6 text-xl mt-6 text-justify w-full" ref={text}></div>
        </div>
