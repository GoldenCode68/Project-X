  ...
  return (
    <div id="content-one-box" className="lg:w-10/12 md:w:10/12 w-full m-auto">
      ...
      <div id="content-two" className="w-full m-auto mt-40">
        ...
        <div className="text-center text-4xl tracking-wider">Our <span
            className="tracking-wider bg-gradient-to-br from-blue-700 from-10% to-purple-700 to-100%0% w-56 text-transparent bg-clip-text">
            Team</span></div>
        <div id="team" className="3xl:w-10/12 w-full m-auto flex justify-around flex-wrap mt-8">
